...
from evaluate_cluster import compute_scores
    ...
    def fit(self, train_data, test_data, meta_data, dataset_name, categorical_columns, ordinal_columns):
        ...
        for i in range(self.epochs):
            ...
            if i % 100 == 0:
                ...
                compute_scores(self.train, self.test, syn_data, self.meta).to_csv(save_loc+"/{}_{}_original.csv".format(dataset_name,i))
