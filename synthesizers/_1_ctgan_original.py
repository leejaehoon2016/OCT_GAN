...
# from evaluate_cluster import compute_scores # 클러스터링 계산 시 사용

import warnings
warnings.filterwarnings(action='ignore')

save_loc = '/home/ctgan/CTGAN_local/result'
...
class CTGANSynthesizer(BaseSynthesizer):
    ...
    def fit(self, train_data, test_data, meta_data, dataset_name, categorical_columns, ordinal_columns):
        ...
        for i in range(self.epochs):
            ...
            s = compute_scores(self.train, self.test, syn_data, self.meta).to_csv(save_loc+"/{}_{}_original.csv".format(dataset_name,i))
            print(s)
            if i % 100 == 0:
                torch.save(self.generator.state_dict(),save_loc+"/G_{}_{}_original.pth".format(dataset_name,i))
                torch.save(self.generator.state_dict(),save_loc+"/D_{}_{}_original.pth".format(dataset_name,i))
                print()
